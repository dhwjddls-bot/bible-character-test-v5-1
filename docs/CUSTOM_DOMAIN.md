...
현재 주소는 `https://dhwjddls-bot.github.io/bible-character-test-v5-1/`입니다. 저장소 이름을 바꾸면 뒤 경로는 바꿀 수 있지만 로그인 반환 주소와 기존 공유 링크도 함께 바뀝니다. 운영 주소를 오래 유지하려면 본인이 소유한 도메인을 연결하는 편이 안전합니다.
